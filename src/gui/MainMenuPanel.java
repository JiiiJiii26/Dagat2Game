...
public class MainMenuPanel extends JPanel {
    ...
    private static final int TITLE_SIZE = 1000;
    private static final int TITLE_Y = -300;
    private static final int TITLE_SPACER_H = 400;
    ...
    private void loadTitleImage() {
        ...
        System.out.println("Title file path: " + titleFile.getAbsolutePath());
            ...
            System.err.println("⚠️ Could not load title: " + e.getMessage());
        }
    }
    ...
    private JButton createPNG3DButton(String imagePath) {
        ...
        int targetH = BUTTON_HEIGHT;
        int targetW = (original.getHeight() > 0) 
            ? (targetH * original.getWidth() / original.getHeight()) 
            : 300;
